...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/rental-mobil/:slug', name: 'rental-mobil-detail', component: () => import('../views/RentalMobilDetailView.vue') },
    { path: '/hotel', name: 'hotel', component: () => import('../views/HotelView.vue') },
    { path: '/hotel/:slug', name: 'hotel-detail', component: () => import('../views/HotelDetailView.vue') },
    { path: '/tiket-pesawat', name: 'tiket-pesawat', component: () => import('../views/TiketPesawatView.vue') },
    { path: '/tiket-pesawat/:id', name: 'tiket-pesawat-detail', component: () => import('../views/TiketPesawatDetailView.vue') },
